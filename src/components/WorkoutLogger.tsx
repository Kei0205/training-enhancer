...
const BODY_PARTS = ['胸', '背中', '足', '肩', '腕', '腹筋', '有酸素', '全身', 'その他', '肩・腕', 'オフ'];
...
const EXERCISE_SUGGESTIONS: Record<string, string[]> = {
  ...
  '肩': ['ショルダープレス', 'サイドレイズ', 'フロントレイズ', 'リアレイズ', 'アップライトロー', 'デルトイドフライ'],
  '腕': ['プリーチャーカール', 'ダンベルカール', 'ハンマーカール', 'ケーブルプレスダウン', 'フレンチプレス', 'トライセプスエクステンション'],
  '腹筋': ['クランチ', 'レッグレイズ', 'アブローラー', 'プランク', 'トーソローテーション'],
  '有酸素': ['ランニングマシン', 'エアロバイク', 'クロストレーナー', 'ステッパー'],
  'その他': [],
